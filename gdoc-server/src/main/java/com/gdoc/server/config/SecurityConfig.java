package com.gdoc.server.config;

import com.gdoc.security.filter.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/", "/index.html", "/editor.html", "/login.html", "/social.html").permitAll()
